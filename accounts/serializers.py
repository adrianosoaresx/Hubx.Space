...
from apps.backend.app.modules.accounts.application.user_rating_creation import (
    CreateUserRatingCommand,
    UserRatingCreationUseCase,
)
from apps.backend.app.modules.accounts.infrastructure.user_rating_creation import (
    DjangoUserRatingCreationRepository,
)

from .models import AccountToken, User, UserRating

_user_rating_creation_uc = UserRatingCreationUseCase(
    repository=DjangoUserRatingCreationRepository(),
)
...
class UserRatingSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        return _user_rating_creation_uc.execute(
