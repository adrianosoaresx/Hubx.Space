...
from core.fields import URLField as CoreURLField
...
class WebhookSubscription(TimeStampedModel, SoftDeleteModel):
    ...
    user: models.ForeignKey = models.ForeignKey(User, on_delete=models.CASCADE, related_name="webhook_subscriptions")
    url: CoreURLField = CoreURLField()
