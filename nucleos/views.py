...
from apps.backend.app.modules.nucleos.application.visibility import (
    get_allowed_classificacao_keys as _get_allowed_classificacao_keys_uc,
    get_consultor_nucleo_ids as _get_consultor_nucleo_ids_uc,
    user_can_manage_nucleacao_requests as _user_can_manage_nucleacao_requests_uc,
    user_has_consultoria_access as _user_has_consultoria_access_uc,
)
...
def _user_has_consultoria_access(user) -> bool:
    return _user_has_consultoria_access_uc(user)


def _get_consultor_nucleo_ids(user) -> set[int]:
    return _get_consultor_nucleo_ids_uc(user)


def _get_allowed_classificacao_keys(user) -> set[str]:
    return _get_allowed_classificacao_keys_uc(user)


def _user_can_manage_nucleacao_requests(
    user, nucleo: Nucleo, consultor_ids: set[int] | None = None
) -> bool:
    return _user_can_manage_nucleacao_requests_uc(user, nucleo, consultor_ids=consultor_ids)
