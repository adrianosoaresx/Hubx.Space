...
from apps.backend.app.modules.organizacoes.application.access_policy import (
    apply_admin_org_scope as _apply_admin_org_scope_uc,
    apply_user_org_scope as _apply_user_org_scope_uc,
)
...
class OrganizacaoListView(AdminRequiredMixin, LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        qs = _apply_admin_org_scope_uc(qs, self.request.user)
...
class OrganizacaoUpdateView(OrgAdminRequiredMixin, LoginRequiredMixin, UpdateView):
    ...
    def get_queryset(self):
        ...
        return _apply_user_org_scope_uc(qs, self.request.user)
...
class OrganizacaoDetailView(AdminRequiredMixin, LoginRequiredMixin, DetailView):
    ...
    def get_queryset(self):
        ...
        return _apply_admin_org_scope_uc(qs, self.request.user)
